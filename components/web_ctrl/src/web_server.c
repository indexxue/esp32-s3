...
static esp_err_t root_get_handler(httpd_req_t *req)
{
    static const char html[] =
        ...
        "<div class='card-b'>"
        "<p class='hint' style='margin-top:0'>调用与串口相同的 <code>ledfx</code> 命令；多场景并行时由固件按优先级抢占显示。</p>"
        "<div class='fx-grid'>"
        "<button type='button' class='btn btn-primary fx-busy' onclick='postCmdLine(\"ledfx run working\",\"fxo\")'>彩虹工作</button>"
        "<button type='button' class='btn btn-ghost fx-busy' onclick='postCmdLine(\"ledfx run pairing\",\"fxo\")'>配网</button>"
        "<button type='button' class='btn btn-ghost fx-busy' onclick='postCmdLine(\"ledfx run config\",\"fxo\")'>配置紫灯</button>"
        "<button type='button' class='btn btn-ghost fx-busy' onclick='postCmdLine(\"ledfx run trigger\",\"fxo\")'>触发</button>"
        "<button type='button' class='btn btn-ghost fx-busy' onclick='postCmdLine(\"ledfx run success\",\"fxo\")'>成功</button>"
        "<button type='button' class='btn btn-ghost fx-busy' onclick='postCmdLine(\"ledfx run net_offline\",\"fxo\")'>断网</button>"
        "<button type='button' class='btn btn-ghost fx-busy' onclick='postCmdLine(\"ledfx run net_online\",\"fxo\")'>回网</button>"
        "<button type='button' class='btn btn-ghost fx-busy' onclick='postCmdLine(\"ledfx run error\",\"fxo\")'>异常</button>"
        "<button type='button' class='btn btn-ghost fx-busy' onclick='postCmdLine(\"ledfx run alarm\",\"fxo\")'>报警</button>"
        "<button type='button' class='btn btn-ghost fx-busy' onclick='postCmdLine(\"ledfx run charging\",\"fxo\")'>充电</button>"
        "<button type='button' class='btn btn-ghost fx-busy' onclick='postCmdLine(\"ledfx run low_battery\",\"fxo\")'>低电量</button>"
        "<button type='button' class='btn btn-ghost fx-busy' onclick='postCmdLine(\"ledfx run bootup\",\"fxo\")'>上电自检</button>"
        "<button type='button' class='btn btn-danger fx-busy' onclick='postCmdLine(\"ledfx cancel all\",\"fxo\")'>停止全部</button>"
        "</div>"
